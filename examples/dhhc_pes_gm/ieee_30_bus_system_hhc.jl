...
################################################################################
# Example considering the harmonic hosting capacity of the IEEE 30 bus test    #
# system using methods presented by different standards taken from: Impact of  #
# Underground Cables on Harmonic Hosting Capacity by T. Van Acker and          #
# H. Ergun, pg. 3, § III.                                                      #
# ---------------------------------------------------------------------------- #
...
# INPUT ########################################################################
# using pkgs
using PowerModels, HarmonicPowerModels
using JuMP
using Ipopt
