...
%
% Adapted from test/data/matpower/industrial_network_hhc.m for the
...
function mpc = industrial_network_shhc
mpc.version = '2';
mpc.baseMVA =  100.00;
...
mpc.branch = [ 
    0       1       0.002377982 0.047559635 0.000000000 1000    1000    1000    1       0       1       -60     60; % Ssc=2.1e9, XRr=20     
